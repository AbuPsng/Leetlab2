...
import { z } from "zod"
import {
    Plus, Trash2, Code2, FileText, Lightbulb, BookOpen, CheckCircle2, Download
} from "lucide-react"
...
import { ProblemSchema } from "../../schemas/auth.schema.js"
...
const CreateProblemForm = () => {
    ...
    const { fields: testCaseFields, append: appendTestCase, remove: removeTestCase, replace: replaceTestCase } = useFieldArray({
        control,
        name: "testCases"
    })

    const { fields: tagFields, append: appendTag, remove: removeTag, replace: replaceTag } = useFieldArray({
        control,
        name: "tags"
    })
